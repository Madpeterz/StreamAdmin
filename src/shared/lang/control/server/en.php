...
$lang = array(
    ...
    "server.cr.error.21" => "api_sync_accounts not vaild",
    "server.cr.error.22" => "event_create_stream not vaild",
    "server.cr.error.23" => "event_update_stream not vaild",
    ...
    "server.up.error.23" => "api_sync_accounts not vaild",
    "server.up.error.24" => "event_create_stream not vaild",
    "server.up.error.25" => "event_update_stream not vaild",
