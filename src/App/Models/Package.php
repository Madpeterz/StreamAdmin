...
use App\Models\Set\TreevenderpackagesSet as TestTreevenderpackages;
use App\Models\Set\NoticenotecardSet as TestNoticenotecard;
use App\Models\Set\ServertypesSet as TestServertypes;
use App\Models\Set\TemplateSet as TestTemplate;
...
class Package extends genClass
{
    ...
    protected $dataset = [
        ...
        "maxStreamsInPackage" => ["type" => "int", "value" => 1],
    ];
    // Setters
    /**
    * setPackageUid
    ...
    */
    ...
    public function relatedTreevenderpackages(?array $limitFields = null): TestTreevenderpackages
    {
        $ids = [$this->getId()];
        $collection = new TestTreevenderpackages();
        if ($limitFields !== null) {
            $collection->limitFields($limitFields);
        }
        $collection->loadFromPackageLinks($ids);
    ...
    public function relatedServertypes(?array $limitFields = null): TestServertypes
    {
        $ids = [$this->getServertypeLink()];
        $collection = new TestServertypes();
        if ($limitFields !== null) {
            $collection->limitFields($limitFields);
        }
        $collection->loadFromIds($ids);
    ...
    public function relatedTemplate(?array $limitFields = null): TestTemplate
    {
        $ids = [$this->getTemplateLink()];
        $collection = new TestTemplate();
        if ($limitFields !== null) {
            $collection->limitFields($limitFields);
        }
        $collection->loadFromIds($ids);
