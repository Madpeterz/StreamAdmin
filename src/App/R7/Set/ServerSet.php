...
class ServerSet extends CollectionSet
{
    ...
    */
     ...
     * @return mixed[] [status =>  bool, count => integer, message =>  string]
    */
    public function loadByApiUsername(
                    string $apiUsername, 
                    int $limit = 0, 
                    string $orderBy = "id", 
                    string $orderDir = "DESC"
     ...
     * @return mixed[] [status =>  bool, count => integer, message =>  string]
    */
    public function loadByApiPassword(
                    string $apiPassword, 
                    int $limit = 0, 
                    string $orderBy = "id", 
                    string $orderDir = "DESC"
    ...
    */
    ...
    /**
     * loadByEventRevokeResetUsername
     * @return mixed[] [status =>  bool, count => integer, message =>  string]
    */
    ...
    /**
     * loadByEventResetPasswordRevoke
     * @return mixed[] [status =>  bool, count => integer, message =>  string]
    */
