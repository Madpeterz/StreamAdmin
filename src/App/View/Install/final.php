...
if ($slconfig->loadID(1) == true) {
    ...
    $this->output->setSwapTagString("page_content", "Setup finished<br/> SL link code: " . $slconfig->getSllinkcode() . "<br/>if you are running in docker please set: INSTALL_OK to 1");
