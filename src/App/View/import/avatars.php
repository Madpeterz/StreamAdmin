...
if ($all_ok == true) {
    $this->output->addSwapTagString("page_content", "Created: " . $avatars_created . " avatars <br/> <a href=\"[[url_base]]import\">Back to menu</a>");
} else {
    $this->output->addSwapTagString("page_content", $lang["av.cr.error.5"]);
    $sql->flagError();
}
