...
* * * * * /usr/local/bin/php /srv/website/src/App/CronTab.php -t=Botcommandq > /proc/1/fd/1 2>&1
${EXPORT_CRON_TIME} /srv/website/.docker/Exporter.sh > /proc/1/fd/1 2>&1
" > scheduler.txt
...
/srv/website/.docker/Exporter.sh > /proc/1/fd/1 2>&1
