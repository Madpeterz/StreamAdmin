...
if($stream->load_by_field("stream_uid",$page) == true)
{
    ...
    $form->col(6);
        ...
        {
            $form->text_input("original_adminusername","Original admin Usr",5,$stream->get_adminusername(),"original adminusername [Restored by API if enabled]");
        }
        else
        {
            $form->hidden_input("original_adminusername","Original admin Usr",5,$stream->get_original_adminusername(),"original adminusername [Restored by API if enabled]");
        }
