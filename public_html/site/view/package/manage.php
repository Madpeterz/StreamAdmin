...
if($package->load_by_field("package_uid",$page) == true)
{
    ...
    $form->col(6);
        $form->group("Textures");
        $form->uuid_input("texture_uuid_soldout","Sold out",$package->get_texture_uuid_soldout(),"UUID of texture");
        $form->uuid_input("texture_uuid_instock_small","In stock [Small]",$package->get_texture_uuid_instock_small(),"UUID of texture");
        $form->uuid_input("texture_uuid_instock_selected","In stock [Selected]",$package->get_texture_uuid_instock_selected(),"UUID of texture");
    $form->col(6);
        $form->group("Auto DJ");
