...
		public function get_autodj() : ?bool
		{
			return $this->get_field("autodj");
		}
		public function get_autodj_size() : ?string
		{
			return $this->get_field("autodj_size");
		}
		public function get_listeners() : ?int
		{
			return $this->get_field("listeners");
		}
		public function get_bitrate() : ?int
		{
			return $this->get_field("bitrate");
		}
		public function get_templatelink() : ?int
		{
			return $this->get_field("templatelink");
		}
		public function get_cost() : ?int
		{
			return $this->get_field("cost");
		}
		public function get_days() : ?int
		{
			return $this->get_field("days");
		}
		public function get_texture_uuid_soldout() : ?string
		{
			return $this->get_field("texture_uuid_soldout");
		}
		public function get_texture_uuid_instock_small() : ?string
		{
			return $this->get_field("texture_uuid_instock_small");
		}
		public function get_texture_uuid_instock_selected() : ?string
		{
			return $this->get_field("texture_uuid_instock_selected");
