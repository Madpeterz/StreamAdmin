...
	class users_set extends collectionSet
	{
		public function get_object_by_field(string $fieldname,$value) : ?users
		{
			return parent::get_object_by_field($fieldname,$value);
		}
		public function get_object_by_id($id=null) : ?users
		{
			return parent::get_object_by_id($id);
		}
		public function get_first() : ?users
