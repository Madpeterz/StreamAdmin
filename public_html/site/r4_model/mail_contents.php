...
	class mail_contents_set extends collectionSet
	{
		public function get_object_by_field(string $fieldname,$value) : ?mail_contents
		{
			return parent::get_object_by_field($fieldname,$value);
		}
		public function get_object_by_id($id=null) : ?mail_contents
		{
			return parent::get_object_by_id($id);
		}
		public function get_first() : ?mail_contents
