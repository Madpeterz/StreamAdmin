...
class GetAlias extends InputFilterWorkerPost
{
    ...
    public function getCheckbox(string $inputName, string $useFilter = "integer"): ?float
    {
        $args  = ["filter" => $useFilter];
        return $this->sharedInputFilter($inputName, $_GET, "checkbox", $args);
    }
